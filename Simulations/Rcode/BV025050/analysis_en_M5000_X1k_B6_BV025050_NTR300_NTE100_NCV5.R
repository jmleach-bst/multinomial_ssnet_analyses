...
# to store errors
file.create(paste0("/data/user/jleach/sim_mn_2021/errors/errors_en_M5000_X1k_B6_BV025050_NTE100_",
                   runID, ".txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = paste0("/data/user/jleach/sim_mn_2021/errors/errors_en_M5000_X1k_B6_BV025050_NTE100_",
                                runID, ".txt"),
                  append = TRUE)
      # write_lines(paste("Iteration #", m , ":", as.character(e)),
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_mn_2021/results/results_en_M5000_X1k_B6_BV025050_NTR300_NTE100_NCV5_",
                      runID, ".RDS"))
# saveRDS(out,
#         file = "/data/user/jleach/sim_mn_2021/results/results_en_M5000_X1k_B6_BV025050_NTR300_NTE100_NCV10.RDS")
