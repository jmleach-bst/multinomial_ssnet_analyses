...
dat.train <- readRDS(
  file = "/data/user/jleach/sim_mn_2021/simdata/sim_data_M5000_X1k_B6_BV025050_NTR300.RDS"
)[sim.ids]
dat.test <- readRDS(
  file = "/data/user/jleach/sim_mn_2021/simdata/sim_data_M5000_X1k_B6_BV025050_NTE100.RDS"
)[sim.ids]

# to store errors
file.create(paste0("/data/user/jleach/sim_mn_2021/errors/errors_lasso_M5000_X1k_B6_BV025050_NTE100_",
                   runID, ".txt"))
# file.create("/data/user/jleach/sim_mn_2021/errors/errors_tr_lasso.txt")
...
for (m in 1:M) {
  tryCatch(
    expr = {
      # cross validation in training set (lasso)
      fit.m <- cv.glmnet(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = paste0("/data/user/jleach/sim_mn_2021/errors/errors_lasso_M5000_X1k_B6_BV025050_NTE100_",
                                runID, ".txt"),
                  append = TRUE)
      # write_lines(paste("Iteration #", m , ":", as.character(e)),
      #             path = "/data/user/jleach/sim_mn_2021/errors/errors_tr_lasso.txt",
      #             append = TRUE)
    },
    finally = {
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_mn_2021/results/results_lasso_M5000_X1k_B6_BV025050_NTR300_NTE100_NCV5_",
                      runID, ".RDS"))
# saveRDS(out,
#         file = "/data/user/jleach/sim_mn_2021/results/results_tr_lasso.RDS")
