...
B2 <- BB
B02 <- -0.15
B2[c(1, 51, 101, 151, 201, 251)] <- 0.25
B2 <- c(B02, B2)
# group 3
B3 <- BB
B03 <- -0.5
B3[c(1, 51, 101, 151, 201, 251)] <- 0.50
B3 <- c(B03, B3)
...
saveRDS(dat.train, 
        file = 
          "/data/user/jleach/sim_mn_2021/simdata/sim_data_M5000_X1k_B6_BV025050_NTR300.RDS")

saveRDS(dat.test, 
        file = 
          "/data/user/jleach/sim_mn_2021/simdata/sim_data_M5000_X1k_B6_BV025050_NTE100.RDS")
