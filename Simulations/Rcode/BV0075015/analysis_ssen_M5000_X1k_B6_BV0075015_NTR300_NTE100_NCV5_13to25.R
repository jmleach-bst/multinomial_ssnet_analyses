...
if (runID_2 == 1){
  ...
  sim.low <- (runID_2 - 1)*200 + 1
  sim.high <- 200 + (runID_2 - 1)*200
  sim.ids <- sim.low:sim.high
}
...
# to store errors
file.create(paste0("/data/user/jleach/sim_mn_2021/errors/errors_ssen_M5000_X1k_B6_BV0075015_NTE100_",
                   runID_2, ".txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  file = paste0("/data/user/jleach/sim_mn_2021/errors/errors_ssen_M5000_X1k_B6_BV0075015_NTE100_",
                                runID_2, ".txt"),
                  append = TRUE)
      # write_lines(paste("Iteration #", m , ":", as.character(e)),
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_mn_2021/results/results_ssen_M5000_X1k_B6_BV0075015_NTR300_NTE100_NCV5_",
                      runID_2, ".RDS"))
# saveRDS(out,
