...
# to store errors
file.create(paste0("/data/user/jleach/sim_mn_2021/errors/errors_lasso_M5000_X1k_B6_BV012025_NTE100_",
                   runID, ".txt"))
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      write_lines(paste("Iteration #", m , ":", as.character(e)),
                  path = paste0("/data/user/jleach/sim_mn_2021/errors/errors_lasso_M5000_X1k_B6_BV012025_NTE100_",
                                runID, ".txt"),
                  append = TRUE)
      # write_lines(paste("Iteration #", m , ":", as.character(e)),
...
saveRDS(out,
        file = paste0("/data/user/jleach/sim_mn_2021/results/results_lasso_M5000_X1k_B6_BV012025_NTR300_NTE100_NCV5_",
                      runID, ".RDS"))
# saveRDS(out,
