---
title: 'ADNI Analysis: Data Management'
...
In other projects we included data management and data analysis in the same file, but this is too cluttered. We use the same ADNI data for several projects and this file discusses topics such as:

(1) How the data were cleaned/processed after obtaining from ADNI. 
(2) Generating neighborhood matrices for when spatial priors are included.
...
It may be relevant to understand how the neighborhood matrix was generated/chosen for the IAR priors. A few comments/clarifications:
